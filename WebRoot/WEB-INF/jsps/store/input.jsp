  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      	<s:textfield size="25" name="sm.name"/>
				      </td>
				      <td width="18%" align="center">仓库地址</td>
				      <td width="32%">
				      	<s:textfield size="25" name="sm.address"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td colspan="3" width="32%">
				      	<s:select name="sm.em.uuid" list="empList" listKey="uuid" listValue="name" cssStyle="width:190px">
							</s:select>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
