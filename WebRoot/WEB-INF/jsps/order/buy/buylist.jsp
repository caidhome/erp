			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td> 
						<s:select name="oqm.type" cssClass="width:113px" list="@cn.itcast.erp.invoice.order.vo.OrderModel@buyTypeMap" headerKey="-1" headerValue="---请-选-择---"/>
						</td>
						<td>下单人:</td>
						<td>
							<s:textfield name="oqm.creater.name" size="14"/>
						</td>
						<td>总量:</td>
