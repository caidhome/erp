				...
				<table width="100%">
					<tr>
						...
						<s:if test="om.type == @cn.itcast.erp.invoice.order.vo.OrderModel@ORDER_TYPE_OF_BUY_BUYING">
							<s:a action="transport_endTask" cssStyle="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
