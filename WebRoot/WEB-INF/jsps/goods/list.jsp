			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td>供应商:</td>
						<td>
							<s:select name="gqm.gtm.sm.uuid" cssClass="kuan" list="supplierList" listKey="uuid" listValue="name" headerKey="-1" headerValue="---请-选-择---"></s:select>
							<%-- <select class="kuan">
						...
						<td><s:textfield size="14" name="gqm.name"/></td>
						<td>生产厂家</td>
						<td><input type="text" size="14" /></td>
						<td>单&nbsp;&nbsp;&nbsp;&nbsp;位</td>
						<td><s:textfield size="14" name="gqm.unit"/></td>
