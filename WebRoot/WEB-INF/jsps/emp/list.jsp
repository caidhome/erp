			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td><s:textfield size="14" name="eqm.username"/></td>
						<td>真实姓名</td>
						<td><s:textfield size="14" name="eqm.name"/></td>
						<td>电&nbsp;&nbsp;&nbsp;&nbsp;话</td>
						<td><s:textfield size="14" name="eqm.tele"/></td>
						<td>性&nbsp;&nbsp;&nbsp;&nbsp;别</td>
						<td>
							<s:select name="eqm.gender" cssClass="kuan" list="@cn.itcast.erp.auth.emp.vo.EmpModel@genderMap" headerKey="-1" headerValue="----请-选-择----"></s:select>
						</td>
							
						<td width="70"><s:a action="emp_input"> <img src="images/can_b_02.gif" border="0" /> </s:a></td>
					</tr>
					<tr>
						<td  height="30">电子邮件</td>
						<td><s:textfield size="14" name="eqm.email"/></td>
						<td>出生日期</td>
						<td>
						...
						<td>部门名称</td>
						<td>
							<s:select name="eqm.dm.uuid" list="depList" listKey="uuid" listValue="name" headerKey="-1" headerValue="----请-选-择----" cssClass="kuan"/>
						</td>
						...
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>
								...
								<span style="line-height:12px; text-align:center;"> 
									<!-- <a href="emp_input.action" class="xiu">修改</a> -->
