...
public class OrderModel {
	...
	public static final String ORDER_ORDERTYPE_OF_RETURN_SALE_VIEW = "采购退货";
	...
	public static final Map<Integer, String> orderTypeMap = new TreeMap<Integer, String>();
	public static final Map<Integer, String> buyTypeMap = new TreeMap<Integer, String>();
	public static final Map<Integer, String> saleTypeMap = new HashMap<Integer, String>();
	...
	static {
		...
		orderTypeMap.put(ORDER_ORDERTYPE_OF_RETURN_BUY,
				ORDER_ORDERTYPE_OF_RETURN_BUY_VIEW);
		orderTypeMap.put(ORDER_ORDERTYPE_OF_RETURN_SALE,
				ORDER_ORDERTYPE_OF_RETURN_SALE_VIEW);
