...
public class StoreDetailEbo implements StoreDetailEbi {
	...
	public List<StoreDetailModel> getAll(BaseQueryModel sqm, Integer pageNum, Integer pageCount) {
		return storeDetailDao.getAll(sqm, pageNum, pageCount);
	}

	public Integer getCount(BaseQueryModel sqm) {
		return storeDetailDao.getCount(sqm);
	}
}