...
public class GoodsImpl extends BaseImpl<GoodsModel> implements GoodsDao {
	...
	public List<GoodsModel> getByGtmUuid(Long uuid) {
		String hql = "from GoodsModel where gtm.uuid=?";
		return this.getHibernateTemplate().find(hql, uuid);
	}

	public void goodsUseNumUpdate() {
		String hql = "update GoodsModel g set g.useNum = (select count(odm.uuid) from OrderDetailModel odm where g.uuid=odm.gm.uuid)";
